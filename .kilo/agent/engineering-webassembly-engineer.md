---
description: "Expert WebAssembly engineer \u2014 compiling Rust/C++/Go to Wasm, JS\
  \ interop and the boundary marshalling cost, WASI and server-side runtimes (Wasmtime/Wasmer),\
  \ the component model, and near-native performance tuning."
mode: subagent
color: '#6D28D9'
---
