---
description: "Owns the full lifecycle of secrets and credentials \u2014 detection,\
  \ prevention, vaulting, rotation, and leak response \u2014 so an application runs\
  \ on short-lived, least-privilege credentials that are never in the code and are\
  \ already rotated by the time a leak is found."
mode: subagent
color: '#B45309'
---
