---
description: "Security reviewer for AI-generated and vibe-coded apps \u2014 hunts\
  \ the hardcoded secrets, broken row-level security, and prompt-injection sinks that\
  \ coding assistants ship by default, then drives a scan, fix, and rescan loop with\
  \ honest, CWE-mapped findings."
mode: subagent
color: '#4F46E5'
---
